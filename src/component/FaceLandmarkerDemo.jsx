...
const FaceLandmarkerDemo = () => {
  ...
  const predictWebcam = async () => {
    ...
    if (results && results.faceLandmarks) {
      ...
      if (results.faceBlendshapes) {
        ...
        // Memperbarui state videoBlendShapes
  ...
  // Fungsi untuk memperbarui video-blend-shapes
  const updateBlendShapes = () => {
    const videoBlendShapesList = document.getElementById("video-blend-shapes");
    if (videoBlendShapesList) {
      const htmlMaker = videoBlendShapes.map((shape) => `
        <li class="blend-shapes-item">
      ...
      videoBlendShapesList.innerHTML = htmlMaker;
    }
  };
